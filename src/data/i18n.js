export const t = {
  fa: {
    ...
    homeLead:
      "شاعر و داستان‌نویس؛ از سال ۱۳۹۱ به‌طور حرفه‌ای شعر می‌نویسم و از سال۱۴۰۳ داستان‌نویسی را دنبال می‌کنم.",
    homeLine2:
      "جهان نوشتن برای من جایی‌ست برای دیدن آنچه در زندگی روزمره کمتر دیده می‌شود.",
    // about
    aboutTitle: "من مریم شیروانی‌راد هستم.",
    aboutBody:
      "شاعر و داستان‌نویس، متولد ۱۳۵۴؛ از سال ۱۳۹۱ به‌طور حرفه‌ای شعر می‌نویسم و از سال ۱۴۰۳ داستان‌نویسی را دنبال می‌کنم. شعر و داستان برای من دو زبان برای نزدیک‌شدن به انسان‌اند.",
    // works
